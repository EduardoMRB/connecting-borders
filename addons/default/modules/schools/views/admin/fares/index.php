<section class="title">
	<h4><?php echo lang('fares:fares'); ?></h4>
</section>
	...
	<?php if (@$fares): ?>
	    <table class="table-list">
			<thead>
				<tr>
					<th width="18%"><?php echo lang('fares:name');?></th>
					<th width="200"><?php echo lang('fares:school');?></th>
					<th width="100"><?php echo lang('fares:price');?></th>
					<th></th>
				</tr>
			</thead>
			<tfoot>
			...
			<?php foreach ($fares as $fare):?>
				<tr>
					...
					<td><?php echo $this->schools_m->get($fare->school_id)->name; ?></td>
