<section class="title">
	<h4><?php echo lang('courses:courses'); ?></h4>
</section>
	...
	<?php if (@$courses): ?>
	    <table class="table-list">
			<thead>
				<tr>
					<th width="18%"><?php echo lang('courses:name');?></th>
					<th width="200"><?php echo lang('courses:school');?></th>
					<th width="100"><?php echo lang('courses:language');?></th>
					<th width="100"><?php echo lang('courses:beginning');?></th>
					<th width="100"><?php echo lang('courses:hourly_load');?></th>
					<th></th>
				</tr>
			</thead>
			<tfoot>
			...
			<?php foreach ($courses as $course):?>
				<tr>
					...
					<td><?php echo $this->schools_m->get($course->school_id)->name; ?></td>
					<td><?php echo $this->languages_m->get($course->language_id)->name; ?></td>
					<td><?php echo  $dates[1] . ' à ' .  $dates[sizeof($dates)-1]; ?></td>
