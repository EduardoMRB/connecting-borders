...
class Theme_Connect extends Theme {

    public $name			= 'Connecting Borders Theme';
    public $author			= 'Infocorp - Soluções em Informação';
    public $author_website	= 'http://www.infocorpconsultoria.com.br';
    public $website			= 'http://www.infocorpconsultoria.com.br';
    public $description		= 'Connecting Borders v0.1 Theme - 2 Column, Fixed width, Horizontal navigation, CSS3 styling.';
    public $version			= '0.1';
